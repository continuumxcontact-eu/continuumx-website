...
export default function ArabicCourseDetailPage({ params }: { params: { slug: string } }) {
  const course = getCourse(params.slug)
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-textMuted dark:text-textMuted">
            <span>
              <strong>{t.courses.level}:</strong> {course.level.ar}
            </span>
            <span>
              <strong>{t.courses.duration}:</strong> {course.duration.ar}
            </span>
            <span>
              <strong>{t.courses.format}:</strong> {course.format.ar}
            </span>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-textMuted dark:text-textMuted">{course.overview.ar}</p>
        </div>

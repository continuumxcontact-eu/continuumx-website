...
export const metadata: Metadata = {
  title: 'Continuum X — الذكاء الاصطناعي والبيانات والتحليلات لأثر واقعي',
  description:
    'نقدّم برامج تدريب احترافية وحلول أعمال مدعومة بالذكاء الاصطناعي لمساعدة الفرق والمؤسسات على اتخاذ قرارات أذكى.',
  openGraph: {
    title: 'Continuum X — الذكاء الاصطناعي والبيانات والتحليلات لأثر واقعي',
    description:
      'نقدّم برامج تدريب احترافية وحلول أعمال مدعومة بالذكاء الاصطناعي لمساعدة الفرق والمؤسسات على اتخاذ قرارات أذكى.',
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                ...
                <Link href="/ar/consultation" className="mt-4 inline-block">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Link href="/ar/courses" className="mt-4 inline-block">
                  <Button variant="outline" size="sm">
                    {t.services.cta}
                  </Button>
                </Link>

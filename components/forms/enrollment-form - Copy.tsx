  ...
  return (
    <Card>
      <CardHeader>
        ...
        {locale === 'ar' ? (
    <>
      شكرًا لاهتمامك ببرامج التدريب الاحترافية من Continuum X.
      <br />
      يرجى ملء النموذج أدناه لحجز مقعدك في الجولة التدريبية الأولى.
      <br />
      ستصلك رسالة تأكيد عبر البريد الإلكتروني تحتوي على تفاصيل الدفع بعد تأكيد الدورة.
    </>
  ) : (
    <>

...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-lightGray bg-surfaceLight/80 backdrop-blur-sm dark:border-borderDark dark:bg-surfaceDark/80">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          >
            ...
            />
            <span className="text-xl font-semibold leading-none"> Continuum <span className="ml-1 text-[#7A0E1B]">X</span>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 top-16 z-40 bg-surfaceLight dark:bg-surfaceDark md:hidden">
          <div className="flex h-[calc(100vh-4rem)] flex-col border-t border-lightGray dark:border-borderDark">
